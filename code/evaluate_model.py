...
if __name__ == '__main__':
    ...
    dataloader, Ns_list, Ms_gt = create_dataloader(scene_names,scene_type='Projective',max_points=None, batch_size=1, shuffle=False, outlier_threshold=None, device=device)
