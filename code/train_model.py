...
if __name__ == '__main__':
    ...
    train_dataloader, train_Ns_list, train_M_gt_list = create_dataloader(training_scenes, scene_type, max_points=10000,batch_size=1, shuffle=False, outlier_threshold=None, device=device)
    val_dataloader, val_Ns_list, val_M_gt_list = create_dataloader(validation_scenes, scene_type, max_points=10000, batch_size=1, shuffle=False, outlier_threshold=None, device=device)
    ...
    train_model(model, train_dataloader, val_dataloader, optimizer, scheduler, loss_fn,
                epochs,train_Ns_list, train_M_gt_list, val_Ns_list, val_M_gt_list, device=device, warmup_epochs=warmup_epochs,
