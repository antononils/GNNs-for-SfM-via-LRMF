...
if __name__ == '__main__':
    ...
    train_dataloader, train_Ns_list, train_M_gt_list = create_dataloader(training_scenes, scene_type, max_points=20000,batch_size=1, shuffle=False, outlier_threshold=None, device=device)
